...
public class Intro_WebHit_Post_UpdateAdminDanetkas {
    ...
    public void postCustomDanetka(Context context, final IWebCallback iWebCallback,
                                  DModelCustomDanetka dModelCustomDanetka, int _id) {
        mContext = context;
        ...
        mClient.patch(myUrl, params, new AsyncHttpResponseHandler() {
                    @Override
