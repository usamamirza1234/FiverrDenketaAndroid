...
public class Intro_WebHit_Post_Results {
    ...
    public void postResults(Context context, final IWebCallback iWebCallback,
                           final String _signInEntity) {
        mContext = context;
        String myUrl = AppConfig.getInstance().getBaseUrlApi() + ApiMethod.POST.addResults;
        Log.d("LOG_AS", "postResults: " + myUrl + _signInEntity);
        ...
        mClient.post(mContext, myUrl, entity, "application/json", new AsyncHttpResponseHandler() {
                    ...
                    public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                        ...
                        try {
                            ...
                            Log.d("LOG_AS", "postResults: strResponse" + strResponse);
